...
export default function ViewRecipes() {
  ...
  const [selectedRecipesModalState, setSelectedRecipesModalState] = useState<string>("")
  ...
  return (
    <div className="hero bg-base-200 min-h-screen t">
      ...
      <button className="btn" onClick={() => {setSelectedRecipesModalState("modal-open")}}>({getSelectedRecipesAmount(selectedRecipes)}) View Selection
