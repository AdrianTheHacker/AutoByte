    ...
    <div className="pt-3 w-dvw flex flex-col justify-center items-center">
      ...
      <dialog id={"view-selection-modal"} className="modal">
        <div className="modal-box max-w-none">
          ...
          <div className="flex flex-row flex-wrap h-96 justify-center gap-5">
            <div className="basis-md h-11/12 overflow-y-scroll">
              <h2 className="font-bold text-lg text-center mb-4">Selected Recipes</h2>
              <table className="table table-zebra overflow-x-auto overflow-y-scroll no-scrollbar basis-lg">
                <tbody>
                  {selectionList.map((recipe) => (
                    <tr key={recipe.id} className="h-7">
            ...
            <div className="basis-md h-11/12 overflow-y-scroll">
              <h2 className="font-bold text-lg text-center mb-4">Ingredients List</h2>
